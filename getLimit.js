...
if (useCurrency) // asset is limiting amount
  if (market1.market != "Binance" && market2.market != "Binance") then
  ...
  if (market2.market = "Binance"){
      ...
      tempStartAsset = paperWallet[trade.market1.market][trade.market1.asset];
      ...
      tempStartCurrency = tempStartAsset * trade.market2.ask / (1 - trade.market2.fees.taker);
  ...
  if (market1.market != "Binance" && market2.market != "Binance"){
    startAsset =
    ...
    startCurrency = paperWallet[trade.market2.market][trade.market2.currency];
      ...
      if (market2.market = "Binance"){
        ...
        tempStartCurrency = paperWallet[trade.market2.market][trade.market2.currency]
        startCurrency = truncate(tempStartCurrency/trade.market2.ask, limitDigits[trade.market2.market][trade.market2.asset])*tradke.market2.ask;
