...
if (useCurrency) {
  ...
  if (market1.market = 'binance') {
    ...
    startAsset = truncate(startCurrency / trade.market2.ask * (1 - trade.market2.fees.taker), limitDigits[trade.market1.market][trade.market1.asset]);
    ...
    startCurrency = truncate(paperWallet[trade.market2.market][trade.market2.currency] / trade.market2.ask, limitDigits[trade.market2.market][trade.market2.asset]) * trade.market2.ask;
